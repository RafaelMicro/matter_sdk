...
static int16_t mSimulatedHumi[]               = { 5500, 5800, 5500, 5000, 5200, 5500, 5300, 5500, 5000, 5200 };
...
void SensorManager::SensorTimerEventHandler(TimerHandle_t xTimer)
{
    ...
    ChipLogProgress(NotSpecified, "Sensor Humidity is : %d", humidity);
    ...
    app::Clusters::RelativeHumidityMeasurement::Attributes::MeasuredValue::Set(kHumidityMeasurementEndpoint, humidity);
