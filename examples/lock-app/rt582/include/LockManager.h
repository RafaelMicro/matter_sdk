...
using namespace RT582DoorLock::ResourceRanges;
...
public:
    ...
    CHIP_ERROR Init(chip::app::DataModel::Nullable<chip::app::Clusters::DoorLock::DlLockState> state,
                    RT582DoorLock::LockInitParams::LockParam lockParam);
    bool NextState();
...
private:
    ...
    RT582DoorLock::LockInitParams::LockParam LockParams;
};
