...
static pwm_seq_para_head_t pwm_para_config[4];
static uint32_t pwm_rdma0_addr_temp[4];
static uint32_t pwm_rdma1_addr_temp[4];
static uint16_t pwm_count_end_val[4] = {
    PWM_PWM0_CNT_END_VAL, 
    PWM_PWM1_CNT_END_VAL, 
    PWM_PWM2_CNT_END_VAL, 
    PWM_PWM3_CNT_END_VAL
};
static pwm_clk_div_t pwm_clk_div[4] = {
    PWM_PWM0_CLK_DIV, 
    PWM_PWM1_CLK_DIV, 
    PWM_PWM2_CLK_DIV, 
    PWM_PWM3_CLK_DIV
};
static pwm_seq_order_t pwm_seq_order[4] = {
    PWM_PWM0_SEQ_ORDER, 
    PWM_PWM1_SEQ_ORDER, 
    PWM_PWM2_SEQ_ORDER, 
    PWM_PWM3_SEQ_ORDER
};
static pwm_trigger_src_t pwm_trigger_src[4] = {
    PWM_PWM0_TRIG_SRC, 
    PWM_PWM1_TRIG_SRC,
    PWM_PWM2_TRIG_SRC,
    PWM_PWM3_TRIG_SRC,
};
static uint16_t pwm_play_cnt[4] = {
    PWM_PWM0_PLAY_CNT, 
    PWM_PWM1_PLAY_CNT,
    PWM_PWM2_PLAY_CNT,
    PWM_PWM3_PLAY_CNT,
};
static pwm_seq_num_t pwm_seq_num[4] = {
    PWM_PWM0_SEQ_NUM, 
    PWM_PWM1_SEQ_NUM,
    PWM_PWM2_SEQ_NUM,
    PWM_PWM3_SEQ_NUM,
};
static pwm_seq_mode_t pwm_seq_mode[4] = {
    PWM_PWM0_SEQ_MODE, 
    PWM_PWM1_SEQ_MODE,
    PWM_PWM2_SEQ_MODE,
    PWM_PWM3_SEQ_MODE,
};
static pwm_counter_mode_t pwm_counter_mode[4] = {
    PWM_PWM0_COUNTER_MODE, 
    PWM_PWM1_COUNTER_MODE,
    PWM_PWM2_COUNTER_MODE,
    PWM_PWM3_COUNTER_MODE,
};
static pwm_dma_smp_fmt_t pwm_dma_smp_fmt[4] = {
    PWM_PWM0_DMA_SML_FMT, 
    PWM_PWM1_DMA_SML_FMT,
    PWM_PWM2_DMA_SML_FMT,
    PWM_PWM3_DMA_SML_FMT,
};
static uint8_t pwm_element_arr[4] = {
    PWM_PWM0_ELEMENT_NUM, 
    PWM_PWM1_ELEMENT_NUM,
    PWM_PWM2_ELEMENT_NUM,
    PWM_PWM3_ELEMENT_NUM,
};
static uint8_t pwm_rep_arr[4] = {
    PWM_PWM0_REPEAT_NUM, 
    PWM_PWM1_REPEAT_NUM,
    PWM_PWM2_REPEAT_NUM,
    PWM_PWM3_REPEAT_NUM,
};
static uint8_t pwm_dly_arr[4] = {
    PWM_PWM0_DLY_NUM, 
    PWM_PWM1_DLY_NUM,
    PWM_PWM2_DLY_NUM,
    PWM_PWM3_DLY_NUM,
