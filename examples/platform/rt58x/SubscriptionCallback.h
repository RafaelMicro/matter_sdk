...
/**
 * @brief The goal of the SubscriptionCallback class is to negotiate the max interval subscription to match the idle interval of
 ...
 */
class SubscriptionCallback : public chip::app::ReadHandler::ApplicationCallback
{
    /**
