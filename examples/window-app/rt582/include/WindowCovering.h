...
public:
    ...
    WindowManager & GetLiftIndicator() { return mLiftIndicator; }
    WindowManager & GetTiltIndicator() { return mTiltIndicator; }
...
private:
    ...
    // LEDWidget mLiftLED;
    // LEDWidget mTiltLED;
    WindowManager mLiftIndicator;
    WindowManager mTiltIndicator;
