...
> **VSCode Task Explorer**: If you have the [Task Explorer](https://marketplace.visualstudio.com/items?itemName=spmeesseman.vscode-taskexplorer) extension installed, you can run the
> **`Matter: Activate Environment`** task instead.
...
> **`Matter: Bootstrap Environment`** task.
...
> **VSCode Task Explorer**: Alternatively, run the **` Matter: Build Example`** task instead, which will prompt you to select the project and board to build.
