...
/** @file "gpPad.h"
 *
 *  Packet Attribute Descriptor interface
 *
 *  Declarations of the public functions and enumerations of gpPad.
 */
...
/** @enum gpPad_Result_t */
//@{
#define gpPad_ResultValidHandle   0
#define gpPad_ResultInvalidHandle 1
#define gpPad_ResultNotInUse      2
