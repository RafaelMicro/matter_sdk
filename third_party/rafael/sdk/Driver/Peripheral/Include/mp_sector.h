...
#define MP_SECTOR_TOTAL_SIZE                                                                                                       \
    (MP_SECTOR_RESERVED_SIZE + MP_SECTOR_ZIGBEE_SIZE + MP_SECTOR_BLE_SIZE + MP_SECTOR_CAL_SIZE + MP_SECTOR_INFO_SIZE)
/*
...
#define MP_ID_TX_POWER_OQPSK_TRIM (0x5A010014)
...
#define MP_CNT_TX_POWER_OQPSK_TRIM (sizeof(mp_tx_power_oqpsk_trim_t))
...
typedef struct __attribute__((packed))
{
    ...
    __IO mp_tx_power_oqpsk_trim_t TX_POWER_OQPSK_TRIM; // offset: 0x0170
    /*
